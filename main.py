...
model = load_model('models/best50_50.h5')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # draw bounding boxes
        left, bottom, label_name = detector_utils.draw_box_on_image(
            model, num_hands_detect, args.score_thresh, scores, boxes, im_width, im_height, image_np)
...
#                    "FPS : " + str(int(fps)), image_np)
            ...
            if label_name != None:
                ...
                draw.text((left, bottom-im_width*0.06),  label_name, font = font, fill = (b, g, r, a))
                image_np = np.array(img_pil)
                
                #cv2.putText(image_np, label_name,  org=(left, bottom-12), fontFace= cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(255,255,255),thickness=2, lineType=cv2.FILLED)
